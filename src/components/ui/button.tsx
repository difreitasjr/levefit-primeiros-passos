  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-2xl shadow-md hover:shadow-lg text-base font-semibold h-14 px-8",
        "hero-outline": "border-2 border-primary/30 text-foreground hover:bg-primary/5 rounded-2xl text-base font-medium h-14 px-8",
        soft: "bg-primary/10 text-primary hover:bg-primary/15 rounded-xl font-medium",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 rounded-xl shadow-sm",
      },
      size: {
